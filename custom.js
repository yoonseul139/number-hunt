...
let computerNum;
let history = []; //입력되는 숫자가 여러 개라서 배열에 넣음
...
function play() {
  ...
  if (chances < 1) {
    ...
    result.textContent = "결과화면 : 게임종료";

    chance.textContent = "남은찬스 : 없음";
